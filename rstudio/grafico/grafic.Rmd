...
author: "Taynara Dutra, Tiago Funk e Rafael Tenfen"
output: 
...
- Segundo o autor Matiusso Jr. (2013) deste exemplo acima, a linha de tendência utilizada para analisar este tipo de gráfico é do tipo "exponencial", a qual sugere o comportamento `O (n log n)`. Assim, a linha de tendência e a linha dos dados podem ser visualizados no mesmo gráfico. 

#### Referências

- Matiusso Jr, Mario E. 2013. Análise empírica de algoritmos de ordenação. Disponível em: <http://matiusso.dx.am/Arquivos/ArtigoAED.pdf> Acesso em: 23/06/2021.
